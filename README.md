...
Full Stack AI Engineer specializing in **production-grade AI systems** from fine-tuned LLMs and RAG pipelines to scalable web platforms. I bridge the gap between cutting-edge AI research and real-world software delivery.

- **AI/ML:** LLMs, RAG, LangChain, Agents, Temporal Fusion Transformers, Multi-task Learning
